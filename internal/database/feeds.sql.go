...
const markFeedsAtFetched = `-- name: MarkFeedsAtFetched :one
UPDATE feeds
...
func (q *Queries) MarkFeedsAtFetched(ctx context.Context, id uuid.UUID) (Feed, error) {
	row := q.db.QueryRowContext(ctx, markFeedsAtFetched, id)
	var i Feed
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
